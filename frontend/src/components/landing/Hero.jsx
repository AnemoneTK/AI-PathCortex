        ...
        <div className=" flex justify-center items-center text-center ">
          <div className="animate-fade-in flex flex-col justify-center items-center ">
            <h1 className="text-3xl md:text-5xl font-bold mb-4 text-theme-blue">
              AI Buddy สำหรับนักศึกษา
              <br />
              <span className="text-gradient">วิทยาการคอมพิวเตอร์</span>
            </h1>
            <p className="text-lg text-gray-600 mb-8">
              ผู้ช่วยอัจฉริยะที่จะช่วยพัฒนาทักษะและให้คำปรึกษาในด้าน Computer
              Science พร้อมด้วย 3 บุคลิกภาพเฉพาะตัว
              ที่สามารถเลือกให้เหมาะกับรูปแบบการเรียนรู้ของคุณ
            </p>
            <div className="flex flex-wrap gap-4">
              <Link href="/registration">
                <Button className="bg-theme-blue hover:bg-blue-800 text-white">
                  เริ่มต้นใช้งาน
                </Button>
              </Link>
            ...
            <div className="flex items-center space-x-8 mt-8 flex justify-center items-center ">
