...
export default function ModernChatPage() {
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "สวัสดี ฉันเป็น AI Buddy ที่จะช่วยให้คำแนะนำเกี่ยวกับอาชีพด้าน IT และคอมพิวเตอร์ คุณมีคำถามอะไรไหม?",
    },
  ]);
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      const errorMessage = {
        role: "assistant",
        content:
          "ขออภัย เกิดข้อผิดพลาดในการเชื่อมต่อกับระบบ โปรดลองอีกครั้งในภายหลัง",
      };
  ...
  return (
    <div
      className={`h-screen w-full flex flex-row ${
        darkMode
          ? "dark bg-gray-900"
